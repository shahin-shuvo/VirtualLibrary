...
import com.sasam.virtuallibrary.ChatRoom.ui.FriendsFragment;
import com.sasam.virtuallibrary.ChatRoom.ui.GroupFragment;
...
//                    Log.d(TAG, "onAuthStateChanged:signed_out");
    ...
    protected void onStop() {
        super.onStop();
        Log.d("authentic","form chatlist on stop");
    ...
    protected void onResume() {
        Log.d("authentic","form chatlist on resume");
        super.onResume();
    }

    @Override
    protected void onPause() {
        Log.d("authentic","form chatlist on pause");
        super.onPause();
    }

    @Override
    protected void onDestroy() {
        Log.d(String.valueOf(R.string.Logger),"form chatlist on destroy");
        ServiceUtils.startServiceFriendChat(getApplicationContext());
        ServiceUtils.userGoesOffline(getApplicationContext());
        super.onDestroy();
    }
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (adapter.getItem(position) instanceof FriendsFragment) {
                    ...
                    floatButton.show();
                    floatButton.setOnClickListener(((GroupFragment) adapter.getItem(position)).onClickFloatButton.getInstance(ChatListActivity.this));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "Virtual Library 1.0", Toast.LENGTH_LONG).show();
            return true;
        }
